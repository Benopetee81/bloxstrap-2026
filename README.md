...
Thanks to [SignPath.io](https://.io/) for providing a free code signing service, and the [SignPath Foundation](https://.org/) for providing the free code signing certificate.
